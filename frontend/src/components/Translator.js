...
function Translator({ username }) {
  ...
  const modelBadge = isCorpusMatch
    ? {
        label: isExact
          ...
          : `✅ Verified Corpus — Semantic Match${similarity ? ` (${similarity})` : ""}`,
        bg: "#dcfce7",
        color: "#15803d",
      }
    : {
  ...
  const sourceDescription = isCorpusMatch
    ...
    : "This translation was generated by NLLB-200. Always verify medical translations with a qualified professional.";
